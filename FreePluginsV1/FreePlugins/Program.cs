...
namespace FreePlugins
{
    public partial class Program
    {
        public static void Main(string[] args)
        {
            ...
            try { serverReferences.Add(typeof(FreePlugins.EFModels.EFModels.User).Assembly.Location); } catch { }
            ...
            try { serverReferences.Add(typeof(FreePlugins.Client.BlazorDataModel).Assembly.Location); } catch { }
            ...
            app.MapHub<freepluginsHub>("/freepluginsHub", signalRConnctionOptions => {
