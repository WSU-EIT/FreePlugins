...
internal class Program
{
    ...
    {
        Console.WriteLine("FreeGLBA Test Client (Using NuGet Package v1.0.1)");
        Console.WriteLine("==================================================\n");
        ...
        try
        {
            var response = await client.LogAccessAsync(new GlbaEventRequest
            {
                ...
                AccessType = "View",
                Purpose = "Testing FreeGLBA client via NuGet package",
                IpAddress = "127.0.0.1"
            });
        ...
        try
        {
            var response = await client.LogAccessAsync(new GlbaEventRequest
            {
                ...
                DataCategory = "Financial",
                AccessType = "Export",
                Purpose = "Testing bulk export logging via NuGet package"
            });
        ...
        var success = await client.TryLogAccessAsync(new GlbaEventRequest
        {
            ...
            AccessType = "View",
            Purpose = "Quick test via NuGet package"
        });
